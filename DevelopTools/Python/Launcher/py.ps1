...
$py37 = "$Env:PYTHONROOT/Python37/python.exe $arglist"
$py38 = "$Env:PYTHONROOT/Python38/python.exe $arglist"
$py39 = "$Env:PYTHONROOT/Python39/python.exe $arglist"
$py_default = "$Env:PYTHONROOT/Python$($default_ver)/python.exe $arglist"
